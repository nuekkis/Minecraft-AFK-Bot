...
```json
{
  "serverHost": "goku789v-P5IB.aternos.me.aternos.me",
  "serverPort": 49036,
  "botUsername": "bot do not working
...
| Key            | Description                                |
| -------------- | ------------------------------------------ |
| `serverHost`         | IP or domain of your Minecraft server      |goku789v-P5IB.aternos.me
| `serverPort`         | Server port (default is 49036)             |
